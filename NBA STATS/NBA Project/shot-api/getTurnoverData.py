...
steal_json = shotchartdetail.ShotChartDetail(
            ...
            context_measure_simple = 'TOV', # this i think can gives us block made shots B
...
with open("./court/data/turnoverdata.json", 'w') as file:
    data_to_download = {"turnovers": steal_locations}
